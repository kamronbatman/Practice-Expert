...
module.exports = function (nqf, meassureName, patId, fromDate, toDate, dctId, fclId, parentDivId) {
  ...
  let cqm0032Denom = require("../cqm-scripts/0032/denom.js");
  cqm0032Denom(patId, fromDate, toDate, dctId, fclId, function(dataDenom){

      let meassureInfoDivId = "info0032Div";
      ...
      if(dataDenom && dataDenom.isCriteriaQualify){
          ...
          let cqm0032DenomExl = require("../cqm-scripts/0032/denom-exl.js");
          cqm0032DenomExl(patId, fromDate, toDate, dctId, fclId, function(dataDenomExl){
            ...
            if(dataDenomExl && dataDenomExl.isCriteriaQualify){
              ...
              let cqm0032Num = require("../cqm-scripts/0032/num.js");
              cqm0032Num(patId, fromDate, toDate, dctId, fclId, function(dataNum){
