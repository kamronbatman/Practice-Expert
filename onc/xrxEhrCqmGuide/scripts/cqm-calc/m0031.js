...
module.exports = function (nqf, meassureName, patId, fromDate, toDate, dctId, fclId, parentDivId){
    ...
    let cqm0031Denom = require("../cqm-scripts/0031/denom.js");
    cqm0031Denom(patId, fromDate, toDate, dctId, fclId, function(dataDenom){

        let meassureInfoDivId = "info0031Div";
        ...
        {
            var cqm0031DenomExl = require("../cqm-scripts/0031/denom-exl.js");
            cqm0031DenomExl(patId, fromDate, toDate, dctId, fclId, function(dataDenomExl){
              ...
              {
                var cqm0031Num = require("../cqm-scripts/0031/num.js");
                cqm0031Num(patId, fromDate, toDate, dctId, fclId, function(dataNum){
