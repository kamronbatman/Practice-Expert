...
module.exports = function (patId, fromDate, toDate, dctId, fclId, callback) {
  ...
  var sql1 = "select PatId from xrxPat pat \
               where ( \
                 ...
                 and ((select dbo.xrxGetPatAge(pat.Birthdate,null, '"+fromDate+"')) >= 66) \
                 and (PatId = '"+patId+"') \
               )";
  var sql2 = "select cqm.PatId \
              ...
              ( \
                ( \
                  (cqm.Code = '99201') or (cqm.Code = '99202') or (cqm.Code = '99203') or \
                  (cqm.Code = '99204') or (cqm.Code = '99205') or (cqm.Code = '99212') or \
                  (cqm.Code = '99213') or (cqm.Code = '99214') or (cqm.Code = '99215') or \
                  ...
                  (cqm.Code = '439708006')  or (cqm.Code = '87790002') or (cqm.Code = '90526000') or \
                  (cqm.Code = '99395') or (cqm.Code = '99396') or (cqm.Code = '99397') or \
                  (cqm.Code = '99385') or (cqm.Code = '99386') or (cqm.Code = '99387') or \
                  (cqm.Code = 'G0438') or (cqm.Code = 'G0439') or \
                  (cqm.Code = '99341') or (cqm.Code = '99342') or (cqm.Code = '99343') or \
                  (cqm.Code = '99344') or (cqm.Code = '99345') or (cqm.Code = '99347') or \
                  (cqm.Code = '99348') or (cqm.Code = '99349') or (cqm.Code = '99350') \
                ) \
